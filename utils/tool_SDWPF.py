...
def loadData_weather(args):
    ...
    weather_1 = normalize(h5load(args.wind_repower_file))
    weather_2 = normalize(h5load(args.wind_dir_file))
    weather_3 = normalize(h5load(args.wind_intmp_file))
    weather_4 = normalize(h5load(args.wind_tmp_file))
    weather_5 = normalize(h5load(args.wind_ndir_file))
    weather_6 = normalize(h5load(args.wind_pab_file))
    weather_7 = normalize(h5load(args.wind_speed_file))
    ...
    train_5, val_5, test_5 = weatherProcess(args,weather_5, wtrain_steps, wval_steps, wtest_steps)
    train_6, val_6, test_6 = weatherProcess(args, weather_6, wtrain_steps, wval_steps, wtest_steps)
    train_7, val_7, test_7 = weatherProcess(args,weather_7, wtrain_steps, wval_steps, wtest_steps)
    ...
    trainW = np.concatenate((trainW, train_5), axis=3).astype(np.float16)
    valW = np.concatenate((valW, val_5), axis=3).astype(np.float16)
    testW = np.concatenate((testW, test_5), axis=3).astype(np.float16)
    trainW = np.concatenate((trainW, train_6), axis=3).astype(np.float16)
    valW = np.concatenate((valW, val_6), axis=3).astype(np.float16)
    testW = np.concatenate((testW, test_6), axis=3).astype(np.float16)
    trainW = np.concatenate((trainW, train_7), axis=3).astype(np.float16)
    valW = np.concatenate((valW, val_7), axis=3).astype(np.float16)
    testW = np.concatenate((testW, test_7), axis=3).astype(np.float16)
