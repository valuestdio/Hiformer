...
import os
import pandas as pd
from model.model_SDWPF import Hiformer
...
parser.add_argument('--P', type=int, default=288,
                    help='history steps')
parser.add_argument('--Q', type=int, default=288,
...
# basic config
parser.add_argument('--wind_power_file', default='data/SDWPF/Wind_power.h5',
                            help='wind_power file')
parser.add_argument('--wind_power_file_mode1', default='data/SDWPF/windpower_mode1.h5',
                            help='wind_power file')
parser.add_argument('--wind_power_file_mode2', default='data/SDWPF/windpower_mode2.h5',
                            help='wind_power file')
parser.add_argument('--wind_power_file_mode3', default='data/SDWPF/windpower_mode3.h5',
                            help='wind_power file')
parser.add_argument('--wind_power_file_mode4', default='data/SDWPF/windpower_mode4.h5',
                            help='wind_power file')
parser.add_argument('--wind_power_file_mode5', default='data/SDWPF/windpower_mode5.h5',
                            help='wind_power file')
parser.add_argument('--wind_power_file_mode6', default='data/SDWPF/windpower_mode6.h5',
                            help='wind_power file')
parser.add_argument('--wind_power_file_mode7', default='data/SDWPF/windpower_mode7.h5',
                            help='wind_power file')
parser.add_argument('--wind_repower_file', default='data/SDWPF/Prtv.h5',
                            help='wind_repower file')
parser.add_argument('--wind_dir_file', default='data/SDWPF/Wdir.h5',
                            help='wind_dir file')
parser.add_argument('--wind_intmp_file', default='data/SDWPF/Itmp.h5',
                            help='wind_intmp file')
parser.add_argument('--wind_tmp_file', default='data/SDWPF/Etmp.h5',
                            help='wind_tmp file')
parser.add_argument('--wind_ndir_file', default='data/SDWPF/Ndir.h5',
                            help='wind_ndir file')
parser.add_argument('--wind_pab_file', default='data/SDWPF/Pab.h5',
                            help='wind_pab file')
parser.add_argument('--wind_speed_file', default='data/SDWPF/Wind_speed.h5',
                            help='wind_speed file')
parser.add_argument('--SE_file', default='data/SDWPF/SE.txt',
...
parser.add_argument('--model_file', default='data/SDWPF/Hiformer_best',
                    help='save the model to disk')
parser.add_argument('--best_model_file', default='data/SDWPF/Hiformer_best_all',
                    help='save the model to disk')
parser.add_argument('--data_file', default='./Temporary Files/SDWPF',
                    help='data file')
...
log_file_path = os.path.join(directory, 'log(windpower)_march_WeaGANbest')
