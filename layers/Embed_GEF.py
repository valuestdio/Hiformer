...
class SpatialEmbedding(nn.Module):
    ...
    def forward(self, SE):
        ...
        Args:
            SE (tensor): Input spatial data of shape (batch_size, 10, P).
        Returns:
            tensor: Embedded spatial data of shape (batch_size, 1, 10, D).
        """
        SE = SE.unsqueeze(1)
        SE = self.linear(SE)
        return SE
...
class TemporalEmbedding(nn.Module):
    ...
    def forward(self, TE):
        ...
        # Create one-hot encodings for month, day of the week, and time of day
...
class WeatherEmbedding(nn.Module):
    ...
    def forward(self, WE):
        ...
        Args:
            WE (tensor): Input weather data of shape (batch_size, P, 10, 4).
        Returns:
            tensor: Embedded weather data of shape (batch_size, 4, 10, D).
        """
...
class Embedding(nn.Module):
    ...
    def forward(self, SE, TE, WE):
        ...
        Args:
            SE (tensor): Spatial embedding input of shape (batch_size, 10, P).
            TE (tensor): Temporal embedding input of shape (batch_size, P, 3).
            WE (tensor): Weather embedding input of shape (batch_size, P, 10, 4).
        Returns:
