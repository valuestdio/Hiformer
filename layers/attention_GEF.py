...
class FrequencyAttention(nn.Module):
    ...
    def forward(self, X_VMD, STE):
        ...
        Args:
            X_VMD (tensor): wind power data after VMD of shape (batch_size, 7, 10, D).
            STE (tensor): Spatial embeddings of shape (batch_size, 1, 10, D).
        Returns:
            tensor: Attention output of shape (batch_size, 1, 10, D).
        """
...
class FeatureAttention(nn.Module):
    ...
    def forward(self, X, SWE):
        ...
        Args:
            X (tensor): wind power after linear layer of shape (batch_size, 1, 10, D).
            SWE (tensor): Spatial-Weather embeddings of shape (batch_size, 4, 10, D).
        Returns:
            tensor: Attention output of shape (batch_size, 1, 10, D).
        """
